...
*****************************************************************************/
    ...
    #define  IBS_HIBYTE(w)          (unsigned char)(w >> 8)
    #define  IBS_LOBYTE(w)          (unsigned char)(w)
...
/* Macros for reading negative confirmation parameters */
    #define  IB_PMS_GetNCnfErrClass(n)      (((USIGN8 IBPTR *)n)[7])
    #define  IB_PMS_GetNCnfErrCode(n)       (((USIGN8 IBPTR *)n)[8])
    #define  IB_PMS_GetNCnfAddCode(n)       ((((USIGN8 IBPTR *)n)[9]<<8) \
                                        | ((USIGN8 IBPTR *)n)[10])
    #define  IB_PMS_GetNCnfPiState(n)       (((USIGN8 IBPTR *)n)[11])
